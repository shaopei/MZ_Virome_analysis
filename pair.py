#5S_PF_scythed_tagcleaned_sickled_H2_R2.fastq
# python seperate_forward_reverse_orphane_reads.py 5S_PF_scythed_tagcleaned_sickled_H2
...
output_orphan_filename = output_folder_path+file_head+"_orphans.fastq"
output_paired_forward_filename = output_folder_path+file_head+"_paired_R1.fastq"
output_paired_reverse_filename = output_folder_path+file_head+"_paired_R2.fastq"
